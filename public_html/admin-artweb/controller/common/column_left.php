...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'menumanager/view')) {
				$menumanager[] = array(
					'name'	   => $this->language->get('text_menumanager_view'),
					'href'     => $this->url->link('menumanager/view', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}

			if ($this->user->hasPermission('access', 'menumanager/viewitem')) {
				$menumanager[] = array(
					'name'	   => $this->language->get('text_menumanager_viewitem'),
					'href'     => $this->url->link('menumanager/viewitem', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}

			if ($this->user->hasPermission('access', 'menumanager/addmenu')) {
				$menumanager[] = array(
					'name'	   => $this->language->get('text_menumanager_addmenu'),
					'href'     => $this->url->link('menumanager/addmenu', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}

			if ($this->user->hasPermission('access', 'menumanager/addmenuitem')) {
				$menumanager[] = array(
					'name'	   => $this->language->get('text_menumanager_addmenuitem'),
					'href'     => $this->url->link('menumanager/addmenuitem', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
			...
			if ($menumanager) {
				$data['menus'][] = array(
					'id'       => 'menu-menumanager',
					'icon'	   => 'fa-university',
					'name'	   => $this->language->get('text_menumanager'),
					'href'     => '',
