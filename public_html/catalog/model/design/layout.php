...
class ModelDesignLayout extends Model {
	...
	public function getLayoutModules($layout_id, $position, $allPagesId = 15) {

		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "layout_module WHERE layout_id IN ('" . (int)$allPagesId . "', '" . (int)$layout_id . "') AND position = '" . $this->db->escape($position) . "' ORDER BY sort_order");
