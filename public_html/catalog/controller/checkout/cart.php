	...
	public function add() {
		...
		if ($product_info) {
			...
			if (!$json) {
				...
				$json['link']=$this->url->link('product/product', 'product_id=' . $this->request->post['product_id']);
				...
				$json['totals'] = $this->cart->countProducts();
				$json['prices'] = $this->currency->format($total, $this->session->data['currency']);
