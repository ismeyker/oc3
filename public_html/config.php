...
// HTTP
define('HTTP_SERVER', 'http://'.$web_name.'/');

// HTTPS
define('HTTPS_SERVER', 'http://'.$web_name.'/');

// DIR
define('DIR_APPLICATION', $web_path.'/catalog/');
define('DIR_SYSTEM', $web_path.'/system/');
define('DIR_IMAGE', $web_path.'/image/');
// define('DIR_STORAGE', 'C:/OpenServer/domains/opencart3.local/storage/');
